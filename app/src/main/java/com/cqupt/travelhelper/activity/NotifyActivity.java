...
import com.cqupt.travelhelper.adapter.NotifyAdapter;
import com.cqupt.travelhelper.module.MyUser;
import com.cqupt.travelhelper.module.Notify;
    ...
    private void queryNotify() {
        ...
        or.findObjects(NotifyActivity.this, new FindListener<Notify>() {
            public void onSuccess(List<Notify> notifyList) {
                ...
                recyclerView.setAdapter(new NotifyAdapter(NotifyActivity.this, notifyList));
            }
