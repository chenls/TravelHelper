...
public class AttractionAdapter extends RecyclerView.Adapter<AttractionAdapter.ViewHolder> {
    ...
    private final AttractionFragment.OnListFragmentInteractionListener mListener;

    public AttractionAdapter(List<DummyItem> items, AttractionFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
